		...
		return (
			<div>
				...
				<p>This react router flux starter was created by <a href="https://github.com/przeor/">PrzeoR</a>.
					...
					While I was learning about FB react flux architecture I used <a
						href="https://egghead.io/series/react-flux-architecture">Flux Architecture for Facebook''s React
						framework screencast (recommended by reactjs team)</a> so you can know that this project is
					using best known flux practises.
				</p>
			</div>
		);
	}
